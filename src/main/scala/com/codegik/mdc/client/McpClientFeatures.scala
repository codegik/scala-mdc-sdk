...
/**
 * Configuration class for MCP client features.
 *
...
/**
 * Builder for McpClientFeatures.
 */
object McpClientFeatures {
  /**
   * Creates a new builder for McpClientFeatures.
   *
  ...
  /**
   * Builder class for McpClientFeatures.
   */
  class Builder {
    ...
    /**
     * Builds the McpClientFeatures.
     *
     * @return The built McpClientFeatures
     */
    def build(): McpClientFeatures = {
      McpClientFeatures(
